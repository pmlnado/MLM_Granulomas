...
model <- glmer(rep_tb ~ CD4_prop + (1 | mouse/lesion) +, data = granuloma_data, family = poisson())


model <- glmer(rep_tb ~ CD4_prop + (1 | mouse/lesion) +  (1 | mouse) + (1 | RS_prop), data = granuloma_data, family = poisson())
#offset nd family gmler??

summary(model)


glmer.nb(RS_prop ~ CD4_prop + (1 | mouse/lesion), data = granuloma_data)

glmer(RS_prop ~ CD4_prop + (1 | mouse/lesion), data = granuloma_data, family = quasipoisson())
