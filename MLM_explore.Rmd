...
```{r}
granuloma_data <- read.csv("/Users/pablo/Documents/R_packages/MLM_Granulomas/IHC_ISH_clean_data_WIP 1.csv")
...
model <- lmer(rep_tb ~ CD4_prop + (1 | mouse), data = granuloma_data)
